                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito1">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito1.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito2">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito2.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito3">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito3.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito4">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito4.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito5">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito5.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito6">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito6.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito7">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito7.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito8">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito8.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito9">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito9.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito10">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito10.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito11">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito11.png') ?>" style="width:88%;">
                                ...
                                <div class="col-md-4 wrapper frito">
                                    ...
                                    <label for="frito12">
                                        <img class="border rounded-3" src="<?= asset('storage/cardapio/frito/frito12.png') ?>" style="width:88%;">
